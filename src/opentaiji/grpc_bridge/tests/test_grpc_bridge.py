...
class TestHermesProviderServicer:
    ...
    def servicer(self):
        """创建服务实例"""
        from grpc_bridge.server import HermesProviderServicer
...
class TestHermesMemoryServicer:
    ...
    def servicer(self):
        """创建服务实例"""
        from grpc_bridge.server import HermesMemoryServicer
...
class TestHermesSkillsServicer:
    ...
    def servicer(self):
        """创建服务实例"""
        from grpc_bridge.server import HermesSkillsServicer
...
class TestHermesAgentServicer:
    ...
    def servicer(self):
        """创建服务实例"""
        from grpc_bridge.server import HermesAgentServicer
...
class TestTaijiVerifyServicer:
    ...
    def servicer(self):
        """创建服务实例"""
        from grpc_bridge.server import TaijiVerifyServicer
...
class TestHermesProviderClient:
    ...
    async def test_chat_request_format(self):
        """测试 Chat 请求格式"""
        from grpc_bridge.serialization import convert_chat_request, MessageValidator
...
class TestSerialization:
    ...
    def test_message_conversion(self):
        """测试消息转换"""
        from grpc_bridge.serialization import MessageConverter
    ...
    def test_struct_conversion(self):
        """测试 Struct 转换"""
        from grpc_bridge.serialization import ToolDefinitionConverter
    ...
    def test_token_usage_format(self):
        """测试 Token 用量格式化"""
        from grpc_bridge.serialization import format_token_usage
    ...
    def test_enum_conversion(self):
        """测试枚举转换"""
        from grpc_bridge.serialization import EnumConverter
...
class TestHealthCheck:
    ...
    async def test_health_servicer(self):
        """测试健康检查服务"""
        from grpc_bridge.health import HealthServicer, HealthStatus
    ...
    async def test_service_monitor(self):
        """测试服务监控器"""
        from grpc_bridge.health import ServiceMonitor, HealthStatus
